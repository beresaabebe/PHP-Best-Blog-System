...
if (isset($_SESSION['lang']) && $_SESSION['lang'] == 'en') {
 $query = "SELECT * FROM posts WHERE post_category_id = '$category_id' ORDER BY updated_date DESC"; 
}
else {
  $query = "SELECT * FROM cn_posts WHERE post_category_id = '$category_id' ORDER BY updated_date DESC";
}
